...
if __name__ == "__main__":
    ...
    spark = (SparkSession.builder
             ...
             .config("spark.jars.packages",
                     "org.apache.spark:spark-sql-kafka-0-10_2.12:3.5.0")  # Ensure compatibility with Scala 2.12
             .config("spark.jars",
                     "/Users/prasanthrentachinthala/PycharmProjects/realtime_voting/postgresql-42.7.1.jar")  # PostgreSQL driver
    ...
    votes_per_candidate_to_kafka = votes_per_candidate.selectExpr("to_json(struct(*)) AS value") \
        ...
        .option("checkpointLocation", "/Users/prasanthrentachinthala/PycharmProjects/realtime_voting/checkpoints/checkpoint1") \
        .outputMode("update") \
        .start()
    ...
    turnout_by_location_to_kafka = turnout_by_location.selectExpr("to_json(struct(*)) AS value") \
        ...
        .option("checkpointLocation", "/Users/prasanthrentachinthala/PycharmProjects/realtime_voting/checkpoints/checkpoint2") \
        .outputMode("update") \
        .start()
